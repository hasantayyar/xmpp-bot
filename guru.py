...
PONDER_MSG = "bilmiyorum veya bunun uzerne dusunmem gerek."
TELLME_MSG = "ben dusunurken sen cevap verebilirsin hem belki yardimci olursun %s"
SOMEONE_ANSWERED_MSG = ("Baskasina sorduk ve cevapladi.")
ANSWER_INTRO_MSG = "bana sordun ki: %s"
ANSWER_MSG = "Epeyce dusundum ve sanirim : %s"
WAIT_MSG = ("Bir soru sordun once cevabi beklemen gerek.")
THANKS_MSG = "Bilge birisin saol."
TELLME_THANKS_MSG = ("Bilge birisin.")
EMPTYQ_MSG = "Sana soracak biseyim yok sanirim. Kusra bakma."
HELP_MSG = ("Ben oldukca gelismis bir robotum. Bana sor. Sadece sor mesela isim sor telefon vereyim. Ama sorularin basina '/hey ' yazman gerek. Bak sunun gibi '/hey Tayyar' dersen Tayyar'in telefonunu veririm.  Dahasi %s/")
MAX_ANSWER_TIME = 120
...
class XmppHandler(xmpp_handlers.CommandHandler):
  ...
  def hey_command(self, message=None):
    im_from = db.IM("xmpp", message.sender)
    asked_question = self._GetAsked(im_from)
    currently_answering = self._GetAnswering(im_from)
